...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p d1c4d3c6-96d5-4a01-ac01-f096177e01c4
```

> `d1c4d3c6-96d5-4a01-ac01-f096177e01c4` is the password of the certificate, you can change it to any password you want.
