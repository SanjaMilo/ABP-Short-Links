...
public class MongoDbLinkStoreDbSchemaMigrator : ILinkStoreDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbLinkStoreDbSchemaMigrator(IServiceProvider serviceProvider)
    {
